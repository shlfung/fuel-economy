type Vehicle = {
  ...
  combined_l_per_100_km: number;
  co2_rating: number;
  model_year: number;
  city_l_per_100_km: number;
  highway_l_per_100_km: number;
  ...
  return (
    <div className="border p-4 rounded shadow-sm hover:shadow-md transition">
      ...
      <div className="mt-2 text-sm">
        <p>City: <strong>{vehicle.city_l_per_100_km} L/100 km</strong></p>
        <p>Highway: <strong>{vehicle.highway_l_per_100_km} L/100 km</strong></p>
        <p>Combined: <strong>{vehicle.combined_l_per_100_km} L/100 km</strong></p>
